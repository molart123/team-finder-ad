...
urlpatterns = [
    ...
    path('projects/<int:id>/toggle-participate/', views.toggle_participate, name='toggle_participate'),
    path('projects/<int:id>/toggle-favorite/', views.toggle_favorite, name='toggle_favorite'),
